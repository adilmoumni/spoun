...
//  }
  ...
  static Uri getNewUri(String path) {
  ...
  Future<bool> onBackPressed() {
    return showDialog(
      ...
      builder: (context) => new AlertDialog(
        title: new Text('Are you sure?', style: TextStyle(color: Colors.deepPurpleAccent),),
        content: new Text('Do you want to exit?'),
        actions: <Widget>[
          new  Padding(padding: EdgeInsets.only(right: 120, left: 10),
