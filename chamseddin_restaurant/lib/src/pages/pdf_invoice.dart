...
class ViewPdfWidget extends StatefulWidget {
  ...
  ViewPdfWidget(this.url);

  @override
  _ViewPdfWidgetWidgetState createState() => _ViewPdfWidgetWidgetState();
}

class _ViewPdfWidgetWidgetState extends StateMVC<ViewPdfWidget> {
  RestaurantController _con;
  int cartCount;
  int notificationsCount;

  _ViewPdfWidgetWidgetState() : super(RestaurantController()) {
    _con = controller;
  }
