...
import 'package:food_delivery_app/src/models/banner_request.dart';
...
import '../models/restaurant_details_request.dart';
...
//Future<Stream<dynamic>> getBanner() async {
//  Uri uri = Helper.getNewUri('banners');
//  print("=== banner uri$uri");
//  try {
//    final client = new http.Client();
//    final streamedRest = await client.send(http.Request('get', uri));
//    return streamedRest.stream
...
//  } catch (e) {
//    print(CustomTrace(StackTrace.current, message: uri.toString()).toString());
//    return new Stream.value(new Banners.fromJson({}));
//  }
//}

Future<Banners> getBanner(String latitude, String longitude) async {
  BannerRequest bannerRequest = new BannerRequest();
  bannerRequest.latitude = latitude;
  bannerRequest.longitude = longitude;
  final String url =
      '${GlobalConfiguration().getString('api_base_url')}banners';
  print(url);
  final client = new http.Client();
  final response = await client.post(
    url,
    headers: {HttpHeaders.contentTypeHeader: 'application/json'},
    body: json.encode(bannerRequest.toMap()),
  );
...
Future<RestaurantDetails> getRestaurantDetails(int restaurant_id) async {
  final String url =
      '${GlobalConfiguration().getString('api_base_url')}restaurant_detail';
  final client = new http.Client();
  RestaurantDetailsRequest detailsRequest = new RestaurantDetailsRequest();
  detailsRequest.restaurant_id = restaurant_id.toString();
  try {
    final response = await client.post(
      url,
      headers: {HttpHeaders.contentTypeHeader: 'application/json'},
